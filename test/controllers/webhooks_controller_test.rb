...
class WebhooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create webhook" do
    assert_difference("Webhook.count") do
      post webhooks_url, params: { webhook: { message: @webhook.message, name: @webhook.name } }, as: :json
    end
  ...
  test "should update webhook" do
    patch webhook_url(@webhook), params: { webhook: { message: @webhook.message, name: @webhook.name } }, as: :json
    assert_response :success
  end
